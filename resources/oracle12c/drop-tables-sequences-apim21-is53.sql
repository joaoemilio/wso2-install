...
drop table HYBRID_ROLE cascade constraints;
drop table HYBRID_USER_ROLE cascade constraints;
...
drop sequence HYBRID_ROLE_SEQUENCE;
drop sequence HYBRID_USER_ROLE_SEQUENCE;
