...
# MB_STORE ORACLE
WSO2_MB_STORE_DB_JDBC_URL="jdbc:mysql://$DB_IP_ADDRESS:3306/wso2"
...
# METRICS ORACLE
WSO2_METRICS_DB_JDBC_URL="jdbc:mysql://$DB_IP_ADDRESS:3306/wso2"
