...
LATEST=`ls -ltr ~/.wum3/products/wso2is-analytics/5.5.0/full/ | tail -n1 | awk '{print $NF}'`
WSO2AM_INSTALL_PATH="/home/wso2/.wum3/products/wso2is-analytics/5.5.0/full/$LATEST"
